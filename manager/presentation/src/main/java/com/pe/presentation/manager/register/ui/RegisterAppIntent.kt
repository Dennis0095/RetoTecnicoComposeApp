...
sealed class RegisterAppIntent{
    ...
    data class UpdateCpuResource(val text: String) : RegisterAppIntent()
    data class UpdateMemoryResource(val text: String) : RegisterAppIntent()
    data class UpdateStorageResource(val text: String) : RegisterAppIntent()
    data class UpdateNetworkConsumptionResource(val text: String) : RegisterAppIntent()
